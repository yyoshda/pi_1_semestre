 ...
 */
package br.maua.presentation.TelaModalAdicionarTurma;

/**
 *
 * @author Lenovo
 */
public class TelaModalAdicionarTurma extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaModalAdicionarTurma.class.getName());

    /**
     * Creates new form TelaModalAdicionarTurma
     */
    public TelaModalAdicionarTurma() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TelaModalAdicionarTurma().setVisible(true));
    }
